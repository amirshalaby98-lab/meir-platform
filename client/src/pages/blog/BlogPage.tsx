...
const blogPosts = [
  ...
  {
    id: 'mobile-car-technician',
    title: 'متى تحتاج فني سيارات متنقل؟ 8 حالات تستدعي الاتصال فوراً',
    excerpt: 'ليس كل عطل يحتاج سحب السيارة للورشة. تعرف على 8 حالات يكون فيها الفني المتنقل هو الحل الأمثل والأسرع، مع مقارنة بين الفني المتنقل والورشة التقليدية.',
    date: '2025-01-10',
    readTime: '6 دقائق',
    category: 'نصائح',
    image: '🚗'
...
export default function BlogPage() {
  return (
    <>
      <Helmet>
        <title>مدونة مير - نصائح صيانة السيارات | فني سيارات متنقل</title>
        <meta name="description" content="مدونة مير لصيانة السيارات - نصائح ومقالات متخصصة في صيانة السيارات، تشخيص الأعطال، البطاريات، السلف والدينمو. تعلم كيف تحافظ على سيارتك." />
        <meta name="keywords" content="مدونة صيانة سيارات، نصائح سيارات، تشخيص أعطال سيارات، بطارية سيارة، سلف سيارة، دينمو سيارة، فني سيارات" />
